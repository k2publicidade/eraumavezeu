            ...
            <div className="flex gap-4 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/5 text-cream/70 transition-all duration-300 hover:border-gold hover:bg-white/10 hover:text-gold"
