      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-light to-primary/5">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-dark/70">
            Tempo médio de resposta: até 1h em horário comercial (9h–18h, seg a
            sex).
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="mt-2 text-dark/70 text-sm">{CONTACT_EMAIL}</p>
            </a>
          </div>
          ...
          <div className="mt-6 bg-white rounded-2xl p-8 border border-primary/10">
            ...
            <p className="mt-2 text-dark/70">
              A maioria das perguntas (prazo, frete, fotos, pagamento) já está
              respondida na página{" "}
              <a
                href="/faq"
                className="text-primary hover:text-primary-dark underline"
              >
