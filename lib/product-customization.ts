...
export const ART_STYLE_OPTIONS = [
  { value: "REALISTA", label: "Realista", description: "Acabamento próximo de uma fotografia", image: "/style_realista.webp", imageAlt: "Exemplo de estilo realista, próximo de uma fotografia" },
  { value: "DESENHO", label: "Desenho", description: "Ilustração clássica e artística", image: "/style_desenho.webp", imageAlt: "Exemplo de ilustração em desenho clássico e artístico" },
  { value: "DIGITAL", label: "Animação digital", description: "Visual tridimensional e contemporâneo", image: "/style_digital.webp", imageAlt: "Exemplo de ilustração digital com acabamento tridimensional" },
] as const;
